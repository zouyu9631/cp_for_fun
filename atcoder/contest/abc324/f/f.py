...
# 浮点数二分
# 二分浮点数模板，精度用参数 D 控制  
# 判断函数中的计算，尽量用整数，速度会快很多
# 另外注意二分的上界，用 bisect_left 时，也需要在 int64 范围内
# 另有代码可参考： https://atcoder.jp/contests/abc324/submissions/46594273
    ...
    class S:
        def __getitem__(self, X: int):
            ...
            for u, v, b, c in edges:
                if dp[u] > -inf:
                    dp[v] = max(dp[v], dp[u] + b * D - c * X)
            return dp[-1] <= 0

    P = bisect_left(S(), True, 1, int(1e9) * D)
    print(P / D)
