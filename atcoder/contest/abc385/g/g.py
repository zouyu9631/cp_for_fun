...
# region Convolution 卷积
# https://atcoder.jp/contests/abc291/submissions/39243280
        ...
        if len_ == 1:
            ...
            for s in range(1 << (len_ - 2)):
                ...
                for i in range(p):
                    ...
                    a[i + offset + p] = (a0 - a1 + a2na3iimag) * irot % _fft_mod
                    a[i + offset + p * 2] = (a0 + a1 - a2 - a3) * irot2 % _fft_mod
                    a[i + offset + p * 3] = (a0 - a1 - a2na3iimag) * irot3 % _fft_mod
                if s + 1 != (1 << (len_ - 1)):
