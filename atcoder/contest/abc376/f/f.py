...
def solve():
    ...
    for _ in range(Q):
        ...
        if h == "L":
            for (l, r), v in dp.items():
                for nl, nr, cost in calc(l, t, r):
                    np[nl, nr] = min(np[nl, nr], v + cost)
        else:
            for (l, r), v in dp.items():
                for nr, nl, cost in calc(r, t, l):
                    np[nl, nr] = min(np[nl, nr], v + cost)
